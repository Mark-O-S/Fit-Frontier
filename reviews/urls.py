...
urlpatterns = [
    ...
    path('delete_review/<int:product_id>/', views.show_delete_product_review, name='show_delete_product_review'),
    path('delete_product_review/<int:product_id>/', views.delete_product_review, name='delete_product_review'),
